...
ALLOWED_HOSTS =['meet.fractalnetworks.co','https://api.meet.fractalnetworks.co','django','django : 8000','api.meet.fractalnetworks.co']
CSRF_TRUSTED_ORIGINS = ['https://api.meet.fractalnetworks.co']
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://api.meet.fractalnetworks.co",
